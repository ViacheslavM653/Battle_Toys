...
#include "BaseUpgradePlayerTank/UpgradeHealthPlayerTank/UpgradeHealthPlayerTank.h"
#include "BasePawn/FriendlyPawn/FriendlyBaseTank/PlayerTank/PlayerTank.h"
#include "Kismet/GameplayStatics.h"

void AUpgradeHealthPlayerTank::OnOverlapBegin(
	...
	const FHitResult& SweepResult)
{
	if ((OtherActor != nullptr) && (OtherActor != this) && (OtherComp != nullptr))
	{
		if (Cast<APlayerTank>(OtherActor))
		{
			...
			PlayerTank->SetHealthUpgrade(UpgradeHealthTankValue);
